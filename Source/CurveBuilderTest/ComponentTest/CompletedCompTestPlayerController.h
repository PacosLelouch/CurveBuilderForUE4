...
#include "CompletedCompTestPlayerController.generated.h"
...
class ACompletedCompTestPlayerController : public ACGDemoPlayerController2D
{
	GENERATED_BODY()

public:
	ACompletedCompTestPlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
