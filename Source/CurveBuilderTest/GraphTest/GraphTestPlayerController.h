...
#include "GraphTestPlayerController.generated.h"
...
class AGraphTestPlayerController : public ACGDemoPlayerController2D
{
	GENERATED_BODY()

public:
	AGraphTestPlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
