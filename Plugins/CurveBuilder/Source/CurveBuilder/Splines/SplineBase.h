...
public:
	...
	virtual void AddPointAtLast(const TVectorX<Dim>& Point, TOptional<double> Param, double Weight = 1.) = 0;

	virtual void AddPointAt(const TVectorX<Dim>& Point, TOptional<double> Param, int32 Index = 0, double Weight = 1.) = 0;
